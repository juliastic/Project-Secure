...
const COMMANDS = [MIN, GRAB_COFFEE, HELP, EXPLAIN, BACKSTORY, LIST_TERMS, CHECK_CAPACITY, CREATE_FIREWALL, LISTEN_REQUESTS, ENABLE_IDS, CHECK_IDS, TOGGLE_HARDMODE, CHECK_EXPLOITS]
